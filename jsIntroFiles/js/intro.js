...
document.getElementById('coloumn3').innerHTML += "<p>Opponent Health: "+health+"</p>";
...
//but if the waepon is dogs then the damage is 25
...
//CONCATENTATE the 'weapon' name and the STRING ' has this much damage: ' and then the 'damage' amount 
document.getElementById('coloumn3').innerHTML += weapon+" have this much damage: "+damage;
